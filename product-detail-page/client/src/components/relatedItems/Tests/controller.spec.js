...
describe('getRelatedProducts', () => {
  test('should return an array of product IDs', () => {
    return controller.getRelatedProducts(37311).then(data => {
      expect(data).toEqual([37312, 37313, 37318, 37317])
    });
  });
  test('Should return an array', () => {
    return controller.getRelatedProducts().then(data => {
      expect(Array.isArray(data)).toBe(true);
    })
  });
  // test('should catch errors', async () => {
  //   expect.assertions(1);
  //   const expectedErrorMessage = 'Error getting related products';
  //   try {
  //     await controller.getRelatedProducts(undefined);
  //   } catch (error) {
...
describe('getProductDetails', () => {
  test('should return a product object', () => {
    return controller.getProductDetails(37311).then(data => {
      expect(data).toEqual({
        "id": 37311,
        "campus": "hr-rfe",
        "name": "Camo Onesie",
  ...
  describe('getProductStyles', () => {
    test('should return an object', () => {
      return controller.getProductStyles(37311).then(data => {
        expect(typeof data).toBe('object')
      })
    })
    test('should return product styles', () => {
      return controller.getProductStyles(37311).then(data => {
        expect(data).toEqual({
          "product_id": "37311",
          "results": [
